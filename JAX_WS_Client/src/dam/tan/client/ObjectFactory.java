 ...
 * generated in the dam.tan.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetPerson_QNAME = new QName("http://tan.dam/", "getPerson");
    private final static QName _GetPersonResponse_QNAME = new QName("http://tan.dam/", "getPersonResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: dam.tan.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tan.dam/", name = "getPerson")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tan.dam/", name = "getPersonResponse")
